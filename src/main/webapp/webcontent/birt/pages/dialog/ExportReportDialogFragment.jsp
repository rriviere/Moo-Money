	...
	<TR>
		...
		<SELECT	ID="exportFormat" NAME="format" CLASS="birtviewer_exportreport_dialog_select">
			<%
				...
				{
					/**
                    *	Modified by Richard Riviere
					*   Old Code: if ( !ParameterAccessor.PARAM_FORMAT_HTML.equalsIgnoreCase( supportedFormats[i] ) 
					*
					* New Code:
					*/
					if ( !ParameterAccessor.PARAM_FORMAT_HTML.equalsIgnoreCase( supportedFormats[i] ) 
							&& !"ppt".equalsIgnoreCase( supportedFormats[i] )
							&& !"ps".equalsIgnoreCase( supportedFormats[i] )
							&& !"ods".equalsIgnoreCase( supportedFormats[i] )
							&& !"odt".equalsIgnoreCase( supportedFormats[i] )
							&& !"odp".equalsIgnoreCase( supportedFormats[i] )
							&& !"postscript".equalsIgnoreCase( supportedFormats[i] )
							)
					/**
					* End change
					*/											
